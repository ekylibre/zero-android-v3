...
import com.ekylibre.android.utils.AuthStateManager;
...
public class AppAuthLogin extends AppCompatActivity {
    ...
    private static final String API_AGRICO = BuildConfig.API_AGRICO;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == RC_AUTH) {
            ...
            if (response != null) {
                ...
                Timber.i("Auth code = %s", response.authorizationCode);
        ...
        authService.performTokenRequest(
                ...
                (resp, ex) -> {
                    if (resp != null) {
                        ...
                        Timber.e(ex,"2 --> Token request failed");
                    }
                });
    }
