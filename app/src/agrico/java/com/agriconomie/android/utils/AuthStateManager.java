...
package com.agriconomie.android.utils;
...
public class AuthStateManager {
    ...
    public static final String STORE_NAME = "prefs";
    private static final String KEY_STATE = "authState";
...
//                editor.remove("token_created_at");
            } else {
                editor.putString(KEY_STATE, state.jsonSerializeString());
//                editor.putString("access_token", state.getAccessToken());
//                editor.putString("refresh_token", state.getRefreshToken());
//                editor.putInt("token_created_at", state.getAccessTokenExpirationTime().intValue());
            }
