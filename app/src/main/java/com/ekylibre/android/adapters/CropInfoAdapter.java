...
public class CropInfoAdapter extends RecyclerView.Adapter<CropInfoAdapter.ViewHolder> {

    private Context context;
    private List<Plots> dataset;

    public CropInfoAdapter(Context context, List<Plots> dataset, SelectCropFragment.OnFragmentInteractionListener fragmentListener) {
    ...
    @NonNull
    @Override
    public CropInfoAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
