...
public class Units {
    ...
    public static final Unit LITER_PER_HECTARE = new Unit("LITER_PER_HECTARE", LITER_FACTOR, HECTARE_FACTOR);
    public static final Unit LITER_PER_SQUARE_METER = new Unit("LITER_PER_SQUARE_METER", LITER_FACTOR, SQUARE_METER_FACTOR);
    public static final Unit HECTOLITER = new Unit("HECTOLITER", HECTOLITER_FACTOR);
    public static final Unit HECTOLITER_PER_HECTARE = new Unit("HECTOLITER_PER_HECTARE", HECTOLITER_FACTOR, HECTARE_FACTOR);
    public static final Unit HECTOLITER_PER_SQUARE_METER = new Unit("HECTOLITER_PER_SQUARE_METER", HECTOLITER_FACTOR, SQUARE_METER_FACTOR);
    public static final Unit CUBIC_METER = new Unit("CUBIC_METER", CUBIC_METER_FACTOR);
    public static final Unit CUBIC_METER_PER_HECTARE = new Unit("CUBIC_METER_PER_HECTARE", CUBIC_METER_FACTOR, HECTARE_FACTOR);
    public static final Unit CUBIC_METER_PER_SQUARE_METER = new Unit("CUBIC_METER_PER_SQUARE_METER", CUBIC_METER_FACTOR, SQUARE_METER_FACTOR);

    // Mass
    public static final Unit GRAM = new Unit("GRAM", GRAM_FACTOR);
    public static final Unit GRAM_PER_HECTARE = new Unit("GRAM_PER_HECTARE", GRAM_FACTOR, HECTARE_FACTOR);
    public static final Unit GRAM_PER_SQUARE_METER = new Unit("GRAM_PER_SQUARE_METER", GRAM_FACTOR, SQUARE_METER_FACTOR);
    public static final Unit KILOGRAM = new Unit("KILOGRAM", KILOGRAM_FACTOR);
    public static final Unit KILOGRAM_PER_HECTARE = new Unit("KILOGRAM_PER_HECTARE", KILOGRAM_FACTOR, HECTARE_FACTOR);
    public static final Unit KILOGRAM_PER_SQUARE_METER = new Unit("KILOGRAM_PER_SQUARE_METER", KILOGRAM_FACTOR, SQUARE_METER_FACTOR);
    public static final Unit QUINTAL = new Unit("QUINTAL", QUINTAL_FACTOR);
    public static final Unit QUINTAL_PER_HECTARE = new Unit("QUINTAL_PER_HECTARE", QUINTAL_FACTOR, HECTARE_FACTOR);
    public static final Unit QUINTAL_PER_SQUARE_METER = new Unit("QUINTAL_PER_SQUARE_METER", QUINTAL_FACTOR, SQUARE_METER_FACTOR);
    public static final Unit TON = new Unit("TON", TON_FACTOR);
    public static final Unit TON_PER_HECTARE = new Unit("TON_PER_HECTARE", TON_FACTOR, HECTARE_FACTOR);
    public static final Unit TON_PER_SQUARE_METER = new Unit("TON_PER_SQUARE_METER", TON_FACTOR, SQUARE_METER_FACTOR);
